...
<body class="theme-blue">
                        ...
                        <div class="body table-responsive">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><fmt:formatDate value="${project.beginDay}" pattern="yyyy-MM-dd" /></td>
                                    <td><fmt:formatDate value="${project.beginDay}" pattern="yyyy-MM-dd" /></td>
                                    <td>${project.intro}</td>
                                    <td>
    ...
    <script>
        ...
        function edit(project) {
            ...
            // 重新设置图片
            if (project.image) { // 只有图片路径有值的情况下才替换"
        ...
        function save() {
            // 获得url
            const requestUrl = "${ctx}/admin/project/save";
            const responseUrl = "${ctx}/admin/project";
            // 获得表单数据
        ...
        function remove(project) {
            swal({
                ...
                // 获得url
                const requestUrl = "${ctx}/admin/project/remove";
                const responseUrl = "${ctx}/admin/project";
                // 获得表单数据
                const formData = {"id": project.id, "image": project.image};
                // 通过ajax调用后台
